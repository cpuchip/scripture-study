	...
	toolList := []ToolDefinition{
		{
			...
			InputSchema: JSONSchema{
				...
				Properties: map[string]JSONSchemaProperty{
					...
					"source": {
						Type:        "string",
						Description: "Filter by content type: scriptures, conference, manual, magazine, music, books, or all (default).",
						Enum:        []string{"scriptures", "conference", "manual", "magazine", "music", "books", "all"},
					},
					"path": {
						Type:        "string",
		...
		},
		{
			...
			InputSchema: JSONSchema{
				...
				Properties: map[string]JSONSchemaProperty{
					"source": {
						Type:        "string",
						Description: "Content type: scriptures, conference, manual, magazine, music, books, or all.",
						Enum:        []string{"scriptures", "conference", "manual", "magazine", "music", "books", "all"},
					},
					"path": {
						Type:        "string",
