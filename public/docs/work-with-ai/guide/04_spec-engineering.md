...
Nate B Jones identifies [five primitives](https://www.youtube.com/watch?v=BpibZSMGtdY&t=1633) — the building blocks of any specification that an agent can execute against:
...
Nate at [20:00](https://www.youtube.com/watch?v=BpibZSMGtdY&t=1200):

> "Your corporate strategy is a specification. Your product strategy is a specification. Your OKRs are a specification. Everything ends up being a specification that your agent can use."
