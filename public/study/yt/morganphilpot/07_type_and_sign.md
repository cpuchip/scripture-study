# Phase 7: The Type & Sign — 9/11, Pharmakeia & Year-by-Year Parallels

> Morgan Philpot — *Signs of the Times* (Chandler, AZ, 2025)
> Slides 229–278 | Part II Transcript (~30:00–55:00) | Part III Transcript (~0:00–25:00)
...
**Bias Alert:** This section combines political interpretation with eschatological claims. The scriptural parallels should be evaluated on their merits, with clear flagging of where the modern mapping requires interpretive leaps vs. where it naturally aligns.
...
3. **Pharmakeia and sorcery** — [Revelation 18:23](https://www.churchofjesuschrist.org/study/scriptures/nt/rev/18?lang=eng&id=p23#p23): "by thy *sorceries* were all nations deceived." The Greek word is φαρμακεία (*pharmakeia*, Strong's 5331), the root of "pharmacy/pharmaceutical." Philpot connects this to [D&C 89:4](https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/89?lang=eng&id=p4#p4) — "evils and designs which do and will exist in the hearts of conspiring men in the last days" — and to [Isaiah 8:19](https://www.churchofjesuschrist.org/study/scriptures/ot/isa/8?lang=eng&id=p19#p19) — "wizards that peep, and that mutter" — arguing that the modern pharmaceutical industry is the literal fulfillment of Babylon's "sorceries." The Webster 1828 definition of "sorcery" bridges the historical-linguistic gap: "divination by the assistance of evil spirits, or the power of commanding evil spirits."

### Key Claims

**9/11 as type of Revelation 18:**
1. The "in one hour" language of Revelation 18:10, 17, 19 maps to the 102-minute collapse timeline of the Twin Towers (slides 240–245)
2. "Merchants of the earth shall weep" (Rev 18:11) maps to the stock market closure and economic devastation (slide 248)
3. "Every shipmaster... stood afar off" (Rev 18:17–18) maps to ships in New York Harbor watching the smoke (slide 249)
4. The Greek *diplōsate*/*dipla* in Rev 18:6 ("double unto her double") = "twofold" = two towers (slides 250–251)
...
**1. The Book of Mormon pride cycle is genuinely cyclical — but cyclical is not chronological.**

Philpot's strongest insight is that the 3 Nephi narrative follows a pattern that *rhymes* with modern events: sign given → people forget → prosperity → pride → secret combinations → gathering → siege → brief peace → rapid spiritual collapse → catastrophic destruction. This is a real narrative arc in the text.

But "rhyming" is different from "year-by-year mapping." Cycles repeat throughout human history — the Roman Republic followed a similar arc over centuries. The French Revolution, the Weimar Republic, and dozens of other societies have experienced prosperity-to-collapse sequences. The Book of Mormon's value as prophecy-for-our-day (as Bednar teaches) lies in the *pattern*, not in matching specific BoM years to specific Gregorian years.

**2. Elder Bednar applies the same scriptures — but spiritually, not politically.**

This is the critical distinction. Bednar draws from the *exact same passages* Philpot uses — Helaman 6, the rapid spiritual decline "in the space of not many years" — but applies them as a warning about *personal and institutional pride within the Church*, not as a political timeline mapping Nephite judges to American presidents. Bednar says:
...
Philpot observes that Nephite "contentious election years" map to US presidential election years (e.g., "29th year" = 2028). But four-year election cycles are a structural feature of representative government, not a prophetic encoding. The Nephite text doesn't specify four-year judicial terms — chief judges served indefinitely until they resigned, died, or were overthrown. Pahoran served from Alma 50:40 (~67 BC) until his death in Helaman 1:2 (~52 BC) — fifteen years. The "four-year cycle" in the timeline spreadsheet appears to be a modern political framework projected onto the text rather than derived from it.
...
The timeline spreadsheet maps 130+ years of American history to Book of Mormon events. When there is no notable American event for a given year, the cell is left blank. When there IS a notable event, it is matched to whatever Book of Mormon narrative falls on that year. This is the fundamental methodological flaw:
...
**3. Mapping modern political figures to Nephite characters is political commentary in scriptural dress.**

The timeline explicitly identifies: Trump = Lachoneus, Musk = Gidgiddoni, Biden = center head of eagle, Obama = specific year markers. The transcript goes further: the Trump successor will be assassinated in 2029 (= 3 Nephi 7:1), and the Church will be "broken up" (= 3 Nephi 6:14 SEC fine).

This is not scripture study. It is political opinion expressed through scriptural vocabulary. The Book of Mormon is not a Republican or Democratic text. Using it to endorse or condemn specific elected officials transforms prophetic warning into partisan advocacy.
...
**1. 3 Nephi 4:30–33 shows the Nephites understood their victory was BY FAITH, not by political strategy.**
...
**2. 3 Nephi 6 tells us *exactly* what broke the church — and it wasn't external enemies.**
...
> "And they began again to prosper and to wax great … And the people began to be distinguished by ranks, according to their riches and their chances for learning" ([3 Nephi 6:4, 12](https://www.churchofjesuschrist.org/study/scriptures/bofm/3-ne/6?lang=eng&id=p4#p4)).
...
**1. Elder Bednar's "In the Space of Not Many Years" (October 2024) is the most relevant conference talk Philpot never cites.**

This is the single biggest missed opportunity in Phase 7. An *apostle* — speaking just months before Philpot's presentation — drew from the *exact same* Helaman/3 Nephi passages and said explicitly:
...
**4. Isaiah 8:20 contains the scripture's own test — and Philpot reads right past it.**
...
Phase 7 contains Philpot's most compelling scriptural observations alongside his most problematic methodological choices.

**What genuinely works:**

The *typological* readings are powerful. The Gadianton-robber narrative resonating with modern terrorism has *prophetic precedent* (Hinckley 2001). The pharmakeia word study is linguistically solid. The Revelation 18 imagery — "in one hour," merchants, ships, sorceries — intersecting with the 9/11 reality is textually striking even if one thinks it's coincidence rather than fulfillment. Elder Bednar applying the same passages to our day (October 2024) validates Philpot's *starting premise* that the Book of Mormon is written for our generation.

And the overarching narrative arc of 3 Nephi — sign → forgetting → prosperity → pride → collapse — is genuinely prophetic in the *pattern* sense. Latter-day Saints across the political spectrum recognize this cycle operating in modern times.
...
**The key question:** Is the Book of Mormon "written for our day" in the sense that its *patterns and principles* warn modern readers? Yes — and Bednar, Hinckley, Benson, and Nelson all teach this. Is it written for our day in the sense that its *chronology* maps year-by-year to the American calendar? That is a much larger claim, and one the prophets themselves have never made.

**The pattern that emerged:** Phase 7 revealed a consistent gap between what the prophets teach from these scriptures and what Philpot teaches:

| Speaker | Same Scriptures | Application |
|---------|-------|-------------|
| President Hinckley (2001) | 3 Nephi / Gadianton | "We see the same thing" — pattern recognition, not year-mapping |
| Elder Bednar (2024) | Helaman 6 | Spiritual pride warning to *Latter-day Saints* — inward application |
| President Nelson (2021, 2025) | D&C 88:91 | "All things in commotion" — invites preparation, refuses dates |
| Philpot (2025) | All of the above + year mapping | Political timeline, specific figures, 2033 date |

The prophets see the patterns and call for repentance. Philpot sees the patterns and builds a calendar. The scriptures support the former approach over the latter.
...
3. **Politicizing scripture cuts it off from people who need it** — If the Book of Mormon is "about Trump" or "about Biden," then half the Church stops listening. The Book of Mormon is about *all of us* — prosperity, pride, repentance, and Christ. The moment it becomes partisan prophecy, it loses its power to convert hearts across the political spectrum.
