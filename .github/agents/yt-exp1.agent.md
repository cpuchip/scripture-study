```chatagent
---
description: 'Experimental eval agent — phased evaluation with externalized memory and critical analysis'
...
# Video Evaluation Agent (Experimental — Phased Writing)
