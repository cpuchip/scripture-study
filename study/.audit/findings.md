# Study correctness walk — findings

Append-only. One section per walked file (chronological). ARGUMENT-class
items ALSO get copied to the "needs Michael" queue at the top so they never
scroll out of sight.

## NEEDS MICHAEL (argument-class queue)

**[1] — RESOLVED 2026-06-12 by Michael's discernment.** `study/bom-walk/studies/1ne4_slaying-of-laban.md` §II "Constrained — Not Commanded." The walk flagged a tension: the study's "constrained = a strong urging, not an irresistible override" cited a 1913 gloss; the genuine 1828 reads "urged **irresistibly**… **necessitated**," which seemed to pull toward compulsion. **Michael's ruling:** the 1828's "necessitated" is NOT compulsion of agency — it is the inescapable *rightness* a free soul yields to ("you see that it must be so; to go against it would be folly, even as the mind races for a way out"). *Constrain* (inward necessity freely yielded) vs *compel* (outward force against the will) holds; and the whole thing is a shadow of Christ's atonement-constraint — He was constrained, shrank ("would that I might not drink the bitter cup, and shrink," D&C 19:18 — the SAME verb as Nephi's "I shrunk," 1 Ne 4:10), yet drank, because "it must needs be an infinite atonement" (2 Ne 9:7), else all creation for naught. §II rewritten to encode this (constrain-vs-compel line + the shrink/Gethsemane shadow, with the §IV take/give asymmetry held). **Queue now EMPTY.**
...
D&C 29:31-32, Abr 4:18/21/26, Abr 5:2, D&C 93:29/30/36, D&C 88:40, Moses 1:39).
Comparative verb table verified (ordered 4:7/9, organized 4:1/12/14-16,
prepared 4:21, concluded 5:3). Key claim verified: "created" never appears in
Abr 4 verse text. Nits (no edits): Moses 1:39 + D&C 88:40 drop sentence-opening
...
### study/truth.md (2026-02-09) — walked out of order at Michael's request, WITH him — 7 requotes + 5 upgrades + 1 micro-fix
T1+FULL. **All 8 Webster claims audited; every argument survived; Michael
ratified "requote + weave the gifts" in-session** (the ARGUMENT gate satisfied
live). The one genuine quote: truth sense 1 ("Conformity to fact or reality;
exact accordance with that which is, or has been, or shall be") — **the
study's centerpiece same-era alignment with D&C 93:24 was genuine 1828 all
along.** Seven 1913 quotes replaced with genuine text; five Key Insights came
back stronger: light = "real matter, existing independent of other substances"
(sense 1!); law = "established by the Creator… denominated in Scripture,
ordinances of heaven"; spirit = "An immaterial intelligent substance" (head-on
with D&C 131:7); intelligence sense 4 = "A spiritual being; as a created
intelligence" (maps to Abr 3:22 better than 1913 did); consciousness sense 1
ends "**Consciousness must be an essential attribute of spirit**" — Webster
answering the study's own section title. Sense-number claims corrected (light
"6th"→4th, intelligence "6th"→4th). Element sense 9 brings 2 Peter 3:10 —
**a ref the 06-12 OCR repair fixed ("3:70"→"3:10"), used same-day.**
...
### study/endtimes-servant.md (2026-03-02) — 2 Webster 1913 (words 84-85)
T1+FULL, post-boundary. ROD and BRANCH were 1913 — requoted; genuine
ROD's first sense is "a branch" (the Isaiah-11 rod-as-branch inside
the entry) and sense 12 is "Rod of iron, the mighty power of Christ.
Rev 19:15." All ~18 scripture renderings verbatim: D&C 113:1-6 (the
...
### Ether 8-11 cluster (2026-06-13, 313→317) — ALL CLEAN

The Jaredite decline: secret combinations from Cain + Moroni's direct
warning to the latter-day Gentiles, the combination devouring its own, the
roll of kings, and the prophets withdrawn. Verified blocks confirmed by
direct grep.

- **Ether 8** (secret combinations + the warning to all lands): v19 "the Lord
  worketh not in secret combinations, neither doth he will that man should
  shed blood," v24 "awake to a sense of your awful situation," v25 "whoso
  buildeth it up seeketh to overthrow the freedom of all lands, nations, and
  countries" — all EXACT.
- **Ether 9** (the combination devours its own): v19 "elephants and cureloms
  and cumoms," v22 Emer "saw the Son of Righteousness… and he died in peace"
  — EXACT (another Jaredite who beheld the premortal Christ).
- **Ether 10** (the roll of kings): v7 Riplakish "his fine gold he did cause
  to be refined in prison," v34 "Com did fight against them much;
  nevertheless, he did not prevail against them" — EXACT.
- **Ether 11** (the prophets withdrawn): v13 "the prophets mourned and
...
8 Webster claims audited; all were 1913; all arguments survived; 3 upgraded
(Isaiah 63:1 apparel bridge, Phil 3:7 gain, 1 Cor 15:40 terrestrial + JST).
Correction note published. The walk's worked example.
