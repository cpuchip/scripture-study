...
**STATUS:** ◷ IN PROGRESS — 1/16 chapters walked.
**NEXT CHAPTER:** ▶ **Moses 2**
...
|------|---------:|:------------:|-------|
| Moses | 8 | **1 ✓** | Selections from the Book of Moses (Gen 1–6 retold + expanded; the visions of Moses & Enoch). ch1 = the vision/prologue: scale→worth (man-is-nothing v10 answered by work-and-glory v39); discernment-by-glory; Satan-as-imposter; Christ-as-Creator (v32-33). |
...
- **Christ as Jehovah / Creator / Only Begotten:** **Moses 1:32-33** — "by the word of my power, have I created them, which is mine Only Begotten Son… by the Son I created them" (worlds without number, made by Christ; the Father speaks, the Son creates). The "Only Begotten" title carries the chapter (v6,16,19,21,32,33). Sets up Moses 2:1.
...
- **Moses 1:9 "fell" → JS—H 1:20** — the overpowered-before-light pattern; Moses' vision and the First Vision are the same shape. Cross-link when JS—H is reached.
