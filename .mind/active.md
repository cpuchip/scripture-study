...
| WS5 | pg-ai-stewards (Postgres substrate for agent state, memory, work, model calls) | 🔨 **Phase 2.5 done May 4 — generic document substrate.** 359 docs across 5 kinds (study/doc/proposal/journal/phase-doc); 1,795 similarity edges. Go CLI cross-compiles to Linux. Cross-kind bridge verified. Recovered 30 silently-lost study docs from old importer's slug collision bug. Phase 2.6 (typed edges + hierarchy) needs design pass. | [scripts/stewards-cli/README.md](../scripts/stewards-cli/README.md) |
