...
*Updated: 2026-05-04 (pg-ai-stewards Phase 2.5 done — generic document substrate; 359 docs across 5 kinds; Go CLI replaces PowerShell; cross-kind bridge verified) · Previous: [archive/active-2026-04-23.md](archive/active-2026-04-23.md)*
...
5. **[WS5] pg-ai-stewards** — Postgres-as-AI-substrate. **Phase 2.5 done May 4 — generic document substrate.** Schema: `kind` column added (study | doc | proposal | phase-doc | journal); `import_study(p_kind)` back-compat. New Go CLI [projects/pg-ai-stewards/cmd/stewards-cli](../projects/pg-ai-stewards/cmd/stewards-cli) cross-compiles to linux/amd64 (13.8 MB) and windows/amd64; replaces PowerShell importer. Slug strategy recovered 30 silently-lost study documents (the old basename-only slug was overwriting `study/talks/*.md` over `study/*.md` with the same name). **Corpus state: 359 docs, 1,795 similarity edges, 2,625 resolves.** Cross-kind bridge verified: this proposal's top-3 mutual neighbors are the journal entries from Phase 2.2/2.3/2.4 — substrate rendered the timeline of its own creation. `creation` (study) ↔ `doc-01_planning-then-create-gospel` at 0.915. Journal YAML parser tolerates four schema versions + falls back to raw text for unparseable files. Next: Phase 2.6 (typed edges + hierarchy) needs its own design pass. → [projects/pg-ai-stewards/cmd/stewards-cli/README.md](../projects/pg-ai-stewards/cmd/stewards-cli/README.md) · [.spec/proposals/pg-ai-stewards-phase-2-5-generic-substrate.md](../.spec/proposals/pg-ai-stewards-phase-2-5-generic-substrate.md) → [projects/pg-ai-stewards/extension/README.md](../projects/pg-ai-stewards/extension/README.md) · [phases.md](../projects/pg-ai-stewards/phases.md)
...
| WS5 | pg-ai-stewards (Postgres substrate for agent state, memory, work, model calls) | 🔨 **Phase 2.5 done May 4 — generic document substrate.** 359 docs across 5 kinds (study/doc/proposal/journal/phase-doc); 1,795 similarity edges. Go CLI lives at projects/pg-ai-stewards/cmd/stewards-cli, cross-compiles to Linux. Cross-kind bridge verified. Recovered 30 silently-lost study docs from old importer's slug collision bug. Phase 2.6 (typed edges + hierarchy) needs design pass. | [projects/pg-ai-stewards/cmd/stewards-cli/README.md](../projects/pg-ai-stewards/cmd/stewards-cli/README.md) |
