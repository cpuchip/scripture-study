...
| WS7 | 1828-illuminated scriptures (1828.ibeco.me) | 🔨 **Phases 1-5 SHIPPED 2026-05-20.** Backend phases 1-4 (three-container stack, scripture corpus, dictionary backend, LLM proxy + BYOK) + phase 5 frontend cutover all landed same day. Frontend now fully API-driven: composables go async against `/api/dict/{1828,modern,search}` with 200-entry LRU; BYOK session-key flow with v1→v2 localStorage migration (api_key never persisted); VerseExplorer canon-browse mode renders `/api/scripture/chapter/{ref}` with tier-word highlights inline + churchofjesuschrist.org breakout (D-BE-COPYRIGHT option D); WordSearch surfaces class-E reach (98,828 vs 853 curated). useWordData chunk dropped from ~1.5MB to 247KB. Steward-mode: Present.vue migrated to async pattern + stem_matched surfaced; stale-query guard in WordSearch; CORS docs reframed as "handled server-side". Commits 6b0e98a + 36419b1 + 70ede1f + 554db8c + bbc1466 + 07bf9f3. Phases 6 (Thummim sync) + 7 (production deploy to 1828.ibeco.me via Dokploy) deferred. Legacy 8082 container untouched throughout. | [phase 5 journal](../projects/1828-illuminated/.spec/journal/2026-05-20-frontend-phase-5-cutover.md) · [phase 1-4 journal](../projects/1828-illuminated/.spec/journal/2026-05-20-backend-phase-1234-build.md) · [proposals](../projects/1828-illuminated/.spec/proposals/) · [project CLAUDE.md](../projects/1828-illuminated/CLAUDE.md) |
