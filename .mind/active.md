...
*Updated: 2026-05-03 (pg-ai-stewards Phase 1 step 6 done — real LM Studio embeddings landing in brain_entries.embedding) · Previous: [archive/active-2026-04-23.md](archive/active-2026-04-23.md)*
...
5. **[WS5] pg-ai-stewards** — Postgres-as-AI-substrate. **Phase 1 steps 1–3+6 done May 2–3: extension + bgworker + brain schema + real LM Studio embeddings landing in vector(768) column (avg 610ms warm, brain_search_vec ranks sensibly).** Three-phase dispatch (claim/HTTP/write) so cold model loads don't hold row locks. Inverse hypothesis confirmed both ways. Next: step 4 (Go migrator) or step 7 (OpenCode Go chat) — Michael leaning toward harness/agent-loop noodling first. → [projects/pg-ai-stewards/extension/README.md](../projects/pg-ai-stewards/extension/README.md) · [phases.md](../projects/pg-ai-stewards/phases.md)
...
| WS5 | pg-ai-stewards (Postgres substrate for agent state, memory, work, model calls) | 🔨 Phase 1 steps 1–3+6 done May 2–3 (extension + bgworker + brain schema + **real LM Studio embeddings** via three-phase dispatch). Next: step 4 (migrator) or step 7 (OpenCode Go chat). | [projects/pg-ai-stewards/extension/README.md](../projects/pg-ai-stewards/extension/README.md) |
