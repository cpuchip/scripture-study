...
| WS7 | 1828-illuminated scriptures (1828.ibeco.me) | 🔨 **MVP + 3 stretch goals + Thummim pipeline shipped 2026-05-20 overnight** under stewardship-delegation. Core: Vue 3 + Vite + Tailwind static SPA, multi-stage Docker, 858-word tier list, eight UI surfaces. Plus the Thummim 2026 Restoration Dictionary substrate pipeline (`thummim-define` family + `stewards.thummim_entries` table, schema-only — no work_items dispatched). Substrate is ready to generate ~150-200 v1 entries on Michael's go-ahead (~$45-50). Commits b66444d → 153ff43. Carry-forward: dispatch first Thummim work_items, gospel-engine-v2 integration, bundle optimization, D-1828-1..5 + D-THM-1..6 ratifications. | [project README](../projects/1828-illuminated/README.md) · [Thummim proposal](../.spec/proposals/thummim-restoration-dictionary.md) · [pipeline SQL](../projects/pg-ai-stewards/extension/thm1-thummim-pipeline-and-schema.sql) |
