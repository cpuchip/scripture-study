...
- Carry-overs indexed in `projects/pg-ai-stewards/.spec/open-items.md` + recent journals; notable: 20 live↔repo function-def mismatches (verify-suite, unclassified) · migrate-manifest design call (Michael) · walls-vs-compulsion audit (preside §V) · **compact_context side-quest SEED (Michael's sketch 2026-06-12, do-not-build until council: `.spec/proposals/substrate-compact-context-sidequest.md`)** · trailing-reminder near true context end (proposal-first; provider quirks; may merge with compact_context council) · #136 CT2.4 RUN-2 nod · #139 Spin offload = the named next big build · voice-bridge V0 ratify.
