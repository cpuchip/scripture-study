...
| WS7 | 1828-illuminated scriptures (1828.ibeco.me) | 🔨 **MVP shipped 2026-05-20 overnight** under stewardship-delegation. New project at `projects/1828-illuminated/`: Vue 3 + Vite + Tailwind static SPA with multi-stage Dockerfile (`docker build && docker run -p 8080:80 1828-illuminated` works locally). 853-word tier list bundled; modern defs fetched at build via Free Dictionary API (1/sec, zero MCP/LM Studio load). Three core surfaces: Home, Word Search (with tier filter), Verse Explorer (hand-curated KJV + Restoration excerpts + paste-your-own). Scripture text NOT bundled — full passages link to churchofjesuschrist.org. Ready for Dokploy deploy to 1828.ibeco.me. | [project README](../projects/1828-illuminated/README.md) · [journal](../projects/1828-illuminated/.spec/journal/2026-05-20-mvp-built-overnight.md) |
