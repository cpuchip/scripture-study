...
| WS7 | 1828-illuminated scriptures (1828.ibeco.me) | 🔨 **MVP + 3 stretch goals shipped 2026-05-20 overnight** under stewardship-delegation. Core: Vue 3 + Vite + Tailwind static SPA, multi-stage Docker, 858-word tier list. Five surfaces: Home, Word Search, Verse Explorer (8 demos + paste-your-own), Dictionary (Thummim 2026 — 3 seed entries demonstrating the multi-level grade-band shape), Presentation mode (tablet-friendly fullscreen). Plus Settings for user-supplied LLM endpoint (LM Studio / opencode-go) that enables "Render in modern English" on any verse (gated; no public cost). Commits b66444d → 0aef597 (plus follow-up Dictionary). Carry-forward: substrate-pipeline-driven Thummim generation; gospel-engine-v2 integration. | [project README](../projects/1828-illuminated/README.md) · [Thummim proposal](../.spec/proposals/thummim-restoration-dictionary.md) |
