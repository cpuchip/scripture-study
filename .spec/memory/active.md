...
3. **Model experiments** — PASSES 1-2 COMPLETE. TITSW V2 VALIDATED. DEEP STUDY DONE. Nemotron-3-nano confirmed as batch winner (3x faster than GLM, 18.5s avg per talk). TITSW v2 prompt closes nemotron-GLM quality gap on talks. Deep content study revealed Alma 32's Christological architecture (seed=Christ, tree=love of God) that models can't score without cross-reference context. **CONTEXT ENGINEERING PROPOSAL WRITTEN** — [.spec/proposals/context-engineering.md](../proposals/context-engineering.md). Next: curate gospel vocabulary + TITSW framework context documents → TITSW v3 prompt (0-9 scale) → validate against ground truth. Scratch: [.spec/scratch/lm-studio-model-experiments/main.md](../scratch/lm-studio-model-experiments/main.md). Ground truth: [experiments/lm-studio/scripts/references/ground-truth-alma32-kearon.md](../../experiments/lm-studio/scripts/references/ground-truth-alma32-kearon.md).
