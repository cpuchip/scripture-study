...
use tools::{resolve_ref, tool_dispatch};
use types::WorkOutcome;
...
// ---------------------------------------------------------------------------
// `resolve_ref` + `tool_dispatch` + exec_* helpers moved to tools.rs
// (Phase 3c.3.6 v3 module split, 2026-05-08).
// ---------------------------------------------------------------------------
