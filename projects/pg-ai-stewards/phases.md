...
> | 3f | **Pivoted 2026-05-09**: original a.ibeco.me cloud spec replaced by local-first single-user UI alongside the docker stack. Read-only state browser + search + pipeline kick-off in v1; Cytoscape.js graph view in v2. Open design questions named (stack: Go-served single binary recommended; service shape: separate `ui` service vs fold into bridge; HTMX vs Alpine vs vanilla; naming). → [proposal](../../.spec/proposals/pg-ai-stewards-3f-local-ui.md) | **proposal 2026-05-09** |
