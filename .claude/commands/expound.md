...
argument-hint: "[short-context-description]"
---
...
**Argument:** `$ARGUMENTS` — the short context description for filename slug. If empty, ask me what to call this collection.

**Output format:**

Create a file at `docs/work-with-ai/examples/{today's-date}-{$ARGUMENTS}.md` with this structure:
