...
> "Exact quote from Read tool" (v. X)
...
2. **Copy exact text.** The quote in the scratch file should be copy-paste from what `Read` returned. No tidying, no paraphrasing. Tidying happens in the draft phase.
