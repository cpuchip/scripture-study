...
- **The full linguistic fingerprint + the Book Gauge** (orthography, rhythm, lexicon, AI-tell zero-list, scoring rubric; built 2026-06-11 from ~163K words across 14 months): [`docs/voice-profile-michael.md`](../../../docs/voice-profile-michael.md) — use it to gauge "does this sound like Michael or AI?" on any first-person passage.
