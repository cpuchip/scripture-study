...
See `docs/general-conference-examples.md` for our analysis of 14 talks across these dimensions.

## Process

1. **Read the full talk** — `Read` the actual talk file from `gospel-library/eng/general-conference/`
